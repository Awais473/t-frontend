      ...
      <SidebarProvider className="overflow-x-hidden">
        ...
        <SidebarInset>
          <header className="sticky top-0 z-30 flex h-14 items-center gap-4 border-b bg-background px-4">
            <SidebarTrigger />
            <h1 className="text-lg font-semibold capitalize">{location.pathname === "/testing" ? "Testing" : location.pathname === "/strategies" ? "Strategies" : "Dashboard"}</h1>
          ...
          <main className="flex-1 space-y-6 p-4 md:p-6 overflow-x-hidden">
            <Routes>
